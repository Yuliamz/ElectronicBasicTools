...
Action paste;
    ...
    public void createActions(){
        ...
        copy.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke('C', InputEvent.CTRL_DOWN_MASK));
        ...
        cut.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke('X', InputEvent.CTRL_DOWN_MASK));
        ...
        paste.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke('V', InputEvent.CTRL_DOWN_MASK));
